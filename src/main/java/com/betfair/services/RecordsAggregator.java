 ...
 */
@Service
public class RecordsAggregator implements Function<Stream<BettingRecord>, Callable<Map<Tuple2<String, Currency>, Tuple3<Long, Double, Double>>>> {

    @Override
    public Callable<Map<Tuple2<String, Currency>, Tuple3<Long, Double, Double>>> apply(Stream<BettingRecord> bettingRecords) {
